...
An image of this project as of *`r Sys.Date()`* can be accessed by <https://mybinder.org/v2/gh/Lindsey-R/psy8712-week8/HEAD>.

An interactive web app is available by <https://purplefishlovespig.shinyapps.io/shiny_week8/>.
